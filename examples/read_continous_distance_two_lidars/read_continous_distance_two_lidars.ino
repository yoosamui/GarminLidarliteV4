/*------------------------------------------------------------------------------
  ...
  *** NOTE ***
  ...
  Please make the you connect two devices and both have a diferent scondary address.
  To configure I2C address use the change_address sketch.
...
#define FAST_I2C
#define LIDAR_ADDR1 0x5B
#define LIDAR_ADDR2 0x64

GarminLidarliteV4 lidar1;
GarminLidarliteV4 lidar2;
...
void setup()
{
  ...
  // ----------------------------------------------------------------------
  lidar1.configure(2, LIDAR_ADDR1);
  lidar2.configure(2, LIDAR_ADDR2);
}
...
{
  uint16_t distance1;
  uint8_t  newDistance1;
  uint16_t distance2;
  uint8_t  newDistance2;

  newDistance1 = lidar1.distanceContinuous(&distance1, LIDAR_ADDR1);
  newDistance2 = lidar2.distanceContinuous(&distance2, LIDAR_ADDR2);
